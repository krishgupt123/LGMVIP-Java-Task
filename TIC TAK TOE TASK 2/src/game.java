...
public class game{
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn2.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn3.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		xCount.setFont(new Font("Times New Roman", Font.BOLD, 45));
		...
		btn4.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn5.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn6.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		oCount.setFont(new Font("Times New Roman", Font.BOLD, 45));
		...
		btn7.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn8.setFont(new Font("Times New Roman", Font.PLAIN, 84));
		...
		btn9.setFont(new Font("Times New Roman", Font.PLAIN, 84));
